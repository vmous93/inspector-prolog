...
check(H, I, J, K, L) :- H = stable, I \= hatred, J \= rope, K \= necklace, L \= saturday, write('Correct answers = 1'),nl, write('Hint! Place is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 20, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I = hatred, J \= rope, K \= necklace, L \= saturday, write('Correct answers = 1'),nl, write('Hint! Motive is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 20, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I \= hatred, J = rope, K \= necklace, L \= saturday, write('Correct answers = 1'),nl, write('Hint! Weapon is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 20, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I \= hatred, J \= rope, K = necklace, L \= saturday, write('Correct answers = 1'),nl, write('Hint! Jewelry is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 20, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I \= hatred, J \= rope, K \= necklace, L = saturday, write('Correct answers = 1'),nl, write('Hint! Date is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 20, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I = hatred, J \= rope, K \= necklace, L \= saturday, write('Correct answers = 2'),nl, write('Hint! Place and Motive are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I \= hatred, J = rope, K \= necklace, L \= saturday, write('Correct answers = 2'),nl, write('Hint! Weapon and Place are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I \= hatred, J \= rope, K = necklace, L \= saturday, write('Correct answers = 2'),nl, write('Hint! Place and jewerly are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I \= hatred, J \= rope, K \= necklace, L = saturday, write('Correct answers = 2'),nl, write('Hint! Date and Place are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I = hatred, J = rope, K \= necklace, L \= saturday, write('Correct answers = 2'),nl, write('Hint! Motive and weapon are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I = hatred, J \= rope, K = necklace, L \= saturday, write('Correct answers = 2'),nl, write('Hint! Motive and Jewelry are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I = hatred, J \= rope, K \= necklace, L = saturday, write('Correct answers = 2'),nl, write('Hint! Motive and Date are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I \= hatred, J = rope, K = necklace, L \= saturday, write('Correct answers = 2'),nl, write('Hint! Weapon and Jewerly are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I \= hatred, J = rope, K \= necklace, L = saturday, write('Correct answers = 2'),nl, write('Hint! Weapon and Motive are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I \= hatred, J \= rope, K = necklace, L = saturday, write('Correct answers = 2'),nl, write('Hint! Weapon and Jewelry are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I = hatred, J = rope, K \= necklace, L \= saturday, write('Correct answers = 3'),nl, write('Hint! Motive and Place and weapon are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I = hatred, J \= rope, K = necklace, L \= saturday, write('Correct answers = 3'),nl, write('Hint! Place and Jewelry and motive are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I = hatred, J \= rope, K \= necklace, L = saturday, write('Correct answers = 3'),nl, write('Hint! Motive and Place and Date are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I \= hatred, J = rope, K = necklace, L \= saturday, write('Correct answers = 3'),nl, write('Hint! Place and Weapon and Jewerly are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I \= hatred, J = rope, K \= necklace, L = saturday, write('Correct answers = 3'),nl, write('Hint! Place and Date and Weapon are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I \= hatred, J \= rope, K = necklace, L = saturday, write('Correct answers = 3'),nl, write('Hint! Jewelry and Place and Date is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I = hatred, J = rope, K = necklace, L \= saturday, write('Correct answers = 3'),nl, write('Hint! Motive and Weapon and jewelry are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I = hatred, J = rope, K \= necklace, L = saturday, write('Correct answers = 3'),nl, write('Hint! Motive and Weapon adn Date are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I \= hatred, J = rope, K = necklace, L = saturday, write('Correct answers = 3'),nl, write('Hint! Weapon and jewelry and Date are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I = hatred, J \= rope, K = necklace, L = saturday, write('Correct answers = 3'),nl, write('Hint! Motive and Jewerly and Date are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= stable, I = hatred, J = rope, K = necklace, L = saturday, write('Correct answers = 4'),nl, write('Hint! Weapon and Motive And Jewerly and Date are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I \= hatred, J = rope, K = necklace, L = saturday, write('Correct answers = 4'),nl, write('Hint! Place and Jewerly and Date and Weapon are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I = hatred, J \= rope, K = necklace, L = saturday, write('Correct answers = 4'),nl, write('Hint! Place and Jewerly and Motive and Date are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I = hatred, J = rope, K \= necklace, L = saturday, write('Correct answers = 4'),nl, write('Hint! Place and Motive and Date and Weapon are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = stable, I = hatred, J = rope, K = necklace, L \= saturday, write('Correct answers = 4'),nl, write('Hint! Place and Motive and Weapon and jewelry are correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)), nl, nl.
