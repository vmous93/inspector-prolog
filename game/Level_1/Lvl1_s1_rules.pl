...
check(X, Y, Z, E) :- X \= friday, Y \= poison, Z \= library, E \= revenge, write('Correct answers = 0'), nl,nl, write('Hint! Date is friday!'),nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write(' date(X) :- day(X), \\+ X = saturday, \\+ X = sunday.'),nl,nl,
    nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 20, assert(p(NewValue)),nl, nl.
                                                 
check(X, Y, Z, E) :- X = friday, Y \= poison, Z \= library, E \= revenge, write('Correct answers = 1'), nl,nl, write('Hint! Date is correct!'), nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write(' date(X) :- day(X), \\+ X = saturday, \\+ X = sunday.'),nl,nl,
    nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.

check(X, Y, Z, E) :- X \= friday, Y = poison, Z \= library, E \= revenge, write('Correct answers = 1'), nl,nl, write('Hint! Weapon is correct!'), nl,
...
check(X, Y, Z, E) :- X \= friday, Y \= poison, Z = library, E \= revenge, write('Correct answers = 1'), nl,nl, write('Hint! Place is correct!'),nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write('crime_place(X, S) :- suspect(X), kills_in(X, S), \\+ S = garden, \\+ S = garage, \\+ S = pool.'),nl,nl,
    nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.

check(X, Y, Z, E) :- X \= friday, Y \= poison, Z \= library, E = revenge, write('Correct answers = 1'), nl,nl, write('Hint! Motive is correct!'),nl,
...
check(X, Y, Z, E) :- X = friday, Y = poison, Z \= library, E \= revenge, write('Correct answers = 2'), nl,nl, write('Hint! Date and Weapon are correct!'),nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write(' date(X) :- day(X), \\+ X = saturday, \\+ X = sunday.'),nl,
...
check(X, Y, Z, E) :- X = friday, Y \= poison, Z = library, E \= revenge, write('Correct answers = 2'), nl,nl, write('Hint! Date and Place are correct!'),nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write(' date(X) :- day(X), \\+ X = saturday, \\+ X = sunday.'),nl,
    write('crime_place(X, S) :- suspect(X), kills_in(X, S), \\+ S = garden, \\+ S = garage, \\+ S = pool.'),nl,nl,
    nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)),nl, nl.

check(X, Y, Z, E) :- X = friday, Y \= poison, Z \= library, E = revenge, write('Correct answers = 2'), nl,nl, write('Hint! Date and Motive correct!'),nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write(' date(X) :- day(X), \\+ X = saturday, \\+ X = sunday.'),nl,
    write('motive_crime(X, Y):- motive(X, Y), \\+ Y = money, \\+ Y = heritage.'),nl,nl,
    nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)),nl, nl.

check(X, Y, Z, E) :- X \= friday, Y = poison, Z = library, E \= revenge, write('Correct answers = 2'), nl,nl, write('Hint! Weapon and Place are correct!'),nl,
...
check(X, Y, Z, E) :- X \= friday, Y = poison, Z \= library, E = revenge, write('Correct answers = 2'), nl,nl, write('Hint! Weapon and Motive are correct!'),nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write(' crime_weapon(X, Y) :- suspect(X), has_weapon(X, Y), \\+ Y = pistol, \\+ Y = knife, \\+ Y = candlestick.'),nl,
    write('motive_crime(X, Y):- motive(X, Y), \\+ Y = money, \\+ Y = heritage.'),nl,nl,
    nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)),nl, nl.

check(X, Y, Z, E) :- X \= friday, Y \= poison, Z = library, E = revenge, write('Correct answers = 2'), nl,nl, write('Hint! Place and Motive are correct!'),nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write('crime_place(X, S) :- suspect(X), kills_in(X, S), \\+ S = garden, \\+ S = garage, \\+ S = pool.'),nl,
    write('motive_crime(X, Y):- motive(X, Y), \\+ Y = money, \\+ Y = heritage.'),nl,nl,
    nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)),nl, nl.

check(X, Y, Z, E) :- X = friday, Y \= poison, Z = library, E = revenge, write('Correct answers = 3'), nl,nl, write('Hint! Date, Motive and Place are correct!'),nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write(' date(X) :- day(X), \\+ X = saturday, \\+ X = sunday.'),nl,
...
check(X, Y, Z, E) :- X = friday, Y = poison, Z \= library, E = revenge, write('Correct answers = 3'), nl,nl, write('Hint! Date, Weapon and Motive are correct!'),nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write(' date(X) :- day(X), \\+ X = saturday, \\+ X = sunday.'),nl,
    write('motive_crime(X, Y):- motive(X, Y), \\+ Y = money, \\+ Y = heritage.'),nl,
    write(' crime_weapon(X, Y) :- suspect(X), has_weapon(X, Y), \\+ Y = pistol, \\+ Y = knife, \\+ Y = candlestick.'),nl,nl,
    nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)),nl, nl.

check(X, Y, Z, E) :- X = friday, Y = poison, Z = library, E \= revenge, write('Correct answers = 3'), nl,nl, write('Hint! Date, Place and Weapon are correct!'),nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write(' date(X) :- day(X), \\+ X = saturday, \\+ X = sunday.'),nl,
    write(' crime_weapon(X, Y) :- suspect(X), has_weapon(X, Y), \\+ Y = pistol, \\+ Y = knife, \\+ Y = candlestick.'),nl,
    write('crime_place(X, S) :- suspect(X), kills_in(X, S), \\+ S = garden, \\+ S = garage, \\+ S = pool.'),nl,nl,
    nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)),nl, nl.

check(X, Y, Z, E) :- X \= friday, Y = poison, Z = library, E = revenge, write('Correct answers = 3'), nl,nl, write('Hint! Place, Motive and Weapon are correct!'),nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write('crime_place(X, S) :- suspect(X), kills_in(X, S), \\+ S = garden, \\+ S = garage, \\+ S = pool.'),nl,
    write('motive_crime(X, Y):- motive(X, Y), \\+ Y = money, \\+ Y = heritage.'),nl,
    write(' crime_weapon(X, Y) :- suspect(X), has_weapon(X, Y), \\+ Y = pistol, \\+ Y = knife, \\+ Y = candlestick.'),nl,nl,
    nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)),nl, nl.

check(X, Y, Z, E) :- X = friday, Y = poison, Z = library, E = revenge, write('Congratulations!! You answered all the questions correctly.'), nl,nl,
    write("Look at this piece of code in Prolog to better understand its rule:"),nl, write(' date(X) :- day(X), \\+ X = saturday, \\+ X = sunday.'),nl,
    write('motive_crime(X, Y):- motive(X, Y), \\+ Y = money, \\+ Y = heritage.'),nl,
    write(' crime_weapon(X, Y) :- suspect(X), has_weapon(X, Y), \\+ Y = pistol, \\+ Y = knife, \\+ Y = candlestick.'),nl,
    write('crime_place(X, S) :- suspect(X), kills_in(X, S), \\+ S = garden, \\+ S = garage, \\+ S = pool.'),nl,
