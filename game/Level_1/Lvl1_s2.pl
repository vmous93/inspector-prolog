...
check(X, Y, Z, E) :- X \= sunday, Y \= poison, Z \= pool, E \= passion, write('Correct answers = 0'), nl, write('Hint! Date is friday!'),nl,nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 20, assert(p(NewValue)),nl, nl.
check(X, Y, Z, E) :- X = sunday, Y \= poison, Z \= pool, E \= passion, write('Correct answers = 1'), nl, write('Hint! Date is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(X, Y, Z, E) :- X \= sunday, Y = poison, Z \= pool, E \= passion, write('Correct answers = 1'), nl, write('Hint! Weapon is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(X, Y, Z, E) :- X \= sunday, Y \= poison, Z = pool, E \= passion, write('Correct answers = 1'), nl, write('Hint! Place is correct!'),nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(X, Y, Z, E) :- X \= sunday, Y \= poison, Z \= pool, E = passion, write('Correct answers = 1'), nl, write('Hint! Motive is correct!'),nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)),nl, nl.
check(X, Y, Z, E) :- X = sunday, Y = poison, Z \= pool, E \= passion, write('Correct answers = 2'), nl, write('Hint! Date and Weapon are correct!'),nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)),nl, nl.
check(X, Y, Z, E) :- X = sunday, Y \= poison, Z = pool, E \= passion, write('Correct answers = 2'), nl, write('Hint! Date and Place are correct!'),nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)),nl, nl.
check(X, Y, Z, E) :- X = sunday, Y \= poison, Z \= pool, E = passion, write('Correct answers = 2'), nl, write('Hint! Date and Motive correct!'),nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)),nl, nl.
check(X, Y, Z, E) :- X \= sunday, Y = poison, Z = pool, E \= passion, write('Correct answers = 2'), nl, write('Hint! Weapon and Place are correct!'),nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)),nl, nl.
check(X, Y, Z, E) :- X \= sunday, Y = poison, Z \= pool, E = passion, write('Correct answers = 2'), nl, write('Hint! Weapon and Motive are correct!'),nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)),nl, nl.
check(X, Y, Z, E) :- X \= sunday, Y \= poison, Z = pool, E = passion, write('Correct answers = 2'), nl, write('Hint! Place and Motive are correct!'),nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)),nl, nl.
check(X, Y, Z, E) :- X = sunday, Y \= poison, Z = pool, E = passion, write('Correct answers = 3'), nl, write('Hint! Date, Motive and Place are correct!'),nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)),nl, nl.
check(X, Y, Z, E) :- X = sunday, Y = poison, Z \= pool, E = passion, write('Correct answers = 3'), nl, write('Hint! Date, Weapon and Motive are correct!'),nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)),nl, nl.
check(X, Y, Z, E) :- X = sunday, Y = poison, Z = pool, E \= passion, write('Correct answers = 3'), nl, write('Hint! Date, Place and Weapon are correct!'),nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)),nl, nl.
check(X, Y, Z, E) :- X \= sunday, Y = poison, Z = pool, E = passion, write('Correct answers = 3'), nl, write('Hint! Place, Motive and Weapon are correct!'),nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)),nl, nl.
check(X, Y, Z, E) :- X = sunday, Y = poison, Z = pool, E = passion, write('Congratulations!! You answered all the questions correctly.'), retract(u(OldValue)), NewValue is OldValue + 1, assert(u(NewValue)), nl,nl.
