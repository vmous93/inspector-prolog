...
check(H, I, J, K, L) :- H \= kitchen, I \= money, J \= knife, K \= necklace, L \= friday, write('Correct answers = 0'),nl, write('Hint! Date is friday!'),nl,nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 25, assert(p(NewValue)),nl, nl.
check(H, I, J, K, L) :- H = kitchen, I \= money, J \= knife, K \= necklace, L \= friday, write('Correct answers = 1'),nl, write('Hint! Place is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 20, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I = money, J \= knife, K \= necklace, L \= friday, write('Correct answers = 1'),nl, write('Hint! Motive is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 20, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I \= money, J = knife, K \= necklace, L \= friday, write('Correct answers = 1'),nl, write('Hint! Weapon is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 20, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I \= money, J \= knife, K = necklace, L \= friday, write('Correct answers = 1'),nl, write('Hint! Jewelry is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 20, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I \= money, J \= knife, K \= necklace, L = friday, write('Correct answers = 1'),nl, write('Hint! Date is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 20, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I = money, J \= knife, K \= necklace, L \= friday, write('Correct answers = 2'),nl, write('Hint! Place is correct! Weapon is incorrect!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I \= money, J = knife, K \= necklace, L \= friday, write('Correct answers = 2'),nl, write('Hint! Weapon is correct! Motive is incorrect!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I \= money, J \= knife, K = necklace, L \= friday, write('Correct answers = 2'),nl, write('Hint! Place is correct! Date is incorrect!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I \= money, J \= knife, K \= necklace, L = friday, write('Correct answers = 2'),nl, write('Hint! Date is correct! Jewelry is incorrect!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I = money, J = knife, K \= necklace, L \= friday, write('Correct answers = 2'),nl, write('Hint! Motive is correct! Date is incorrect!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I = money, J \= knife, K = necklace, L \= friday, write('Correct answers = 2'),nl, write('Hint! Jewelry is correct! Weapon is incorrect!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I = money, J \= knife, K \= necklace, L = friday, write('Correct answers = 2'),nl, write('Hint! Date is correct! Place is incorrect!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I \= money, J = knife, K = necklace, L \= friday, write('Correct answers = 2'),nl, write('Hint! Weapon is correct! Motive is incorrect!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I \= money, J = knife, K \= necklace, L = friday, write('Correct answers = 2'),nl, write('Hint! Weapon is correct! Place is incorrect!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I \= money, J \= knife, K = necklace, L = friday, write('Correct answers = 2'),nl, write('Hint! Jewelry is correct! Weapon is incorrect!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 15, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I = money, J = knife, K \= necklace, L \= friday, write('Correct answers = 3'),nl, write('Hint! Place and Motive is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I = money, J \= knife, K = necklace, L \= friday, write('Correct answers = 3'),nl, write('Hint! Place and Jewelry is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I = money, J \= knife, K \= necklace, L = friday, write('Correct answers = 3'),nl, write('Hint! Motive and Date is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I \= money, J = knife, K = necklace, L \= friday, write('Correct answers = 3'),nl, write('Hint! Place and Weapon is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I \= money, J = knife, K \= necklace, L = friday, write('Correct answers = 3'),nl, write('Hint! Place and Date is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I \= money, J \= knife, K = necklace, L = friday, write('Correct answers = 3'),nl, write('Hint! Jewelry and Date is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I = money, J = knife, K = necklace, L \= friday, write('Correct answers = 3'),nl, write('Hint! Motive and jewelry is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I = money, J = knife, K \= necklace, L = friday, write('Correct answers = 3'),nl, write('Hint! Motive and Weapon is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I \= money, J = knife, K = necklace, L = friday, write('Correct answers = 3'),nl, write('Hint! Weapon and jewelry is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I = money, J \= knife, K = necklace, L = friday, write('Correct answers = 3'),nl, write('Hint! Motive and Date is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 10, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H \= kitchen, I = money, J = knife, K = necklace, L = friday, write('Correct answers = 4'),nl, write('Hint! Weapon and Date is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I \= money, J = knife, K = necklace, L = friday, write('Correct answers = 4'),nl, write('Hint! Place and Weapon is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I = money, J \= knife, K = necklace, L = friday, write('Correct answers = 4'),nl, write('Hint! Motive and Date is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I = money, J = knife, K \= necklace, L = friday, write('Correct answers = 4'),nl, write('Hint! Place and Motive is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)), nl, nl.
check(H, I, J, K, L) :- H = kitchen, I = money, J = knife, K = necklace, L \= friday, write('Correct answers = 4'),nl, write('Hint! Weapon and jewelry is correct!'), nl, nl, write('Try again and refine your answers'), retract(p(OldValue)), NewValue is OldValue - 5, assert(p(NewValue)), nl, nl.
